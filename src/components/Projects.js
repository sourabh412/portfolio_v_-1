...
function Projects() {
    ...
    return (
        <>
            ...
            <motion.div className='lg:w-4/5 h-auto mx-auto flex flex-wrap justify-center gap-20'
                variants={outer}
                initial="offscreen"
                whileInView="onscreen"
                transition={{ duration: 0.5 }}
                    ...
                    newGit.map((item) => (
                        ...
                        >
                            ...
                            <div className="flex justify-center gap-6">
                                <a href={item.link} target="_blank" className={(!item.link) ? "hidden" : ""}>
                                    <div>
                            ...
                            <h1 className='text-center text-base font-bold font-roboto-300 mb-3'>{item.name1}</h1>
                            <p className='text-gray-500 text-justify'>{item.desc}</p>
                            <p className='hidden'>{item.type}</p>
                        </motion.div>
                    ))
                }
            </motion.div>
